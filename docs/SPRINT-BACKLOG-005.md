# Sprint Backlog 005 — Eva: Conversational AI Onboarding
...
**RAG отложен:** Полный pgvector RAG pipeline — Sprint 5. Sprint 4 использует condensed AI Act reference в system prompt (~4K токенов: Art. 4, 5, 26-27, 50). Mistral Large 3 имеет 128K контекста — достаточно.
