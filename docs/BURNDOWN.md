...
> **Текущее состояние:** 14 спринтов завершено, 4 осталось | 289 SP / ~365 SP (79%)
> **Тесты:** 457 (270 Engine + 187 TUI) | **User Stories:** 64 / 83
...
| Метрика | Значение |
|---------|----------|
| Спринтов завершено | 14 (Phase 0, Data, E01, T02, T02.5, E03, E04, T03, T04, T05, E05, E06, T06, T07) |
| Спринтов осталось | 4 (E07, E08, T08, L09) |
| SP завершено | **289** |
| SP осталось | **76** |
| SP итого | **~365** |
...
| Тесты итого | **457** |
| User Stories завершено | **64** |
| Средняя скорость | **22.2 SP/спринт** |
...
| **Итого** | **286** | **286** | **12 дней** | **23.8 avg** |
...
114 ┤                      ■
 ...
 40 ┤                                ·
  ...
  0 ┤                                    ·
    └──┬──┬──┬──┬──┬──┬──┬──┬──┬──┬──┬──┬──┬──┬──┬──┬──┬──┐
       P0 E1 T2 2.5 E3 E4 T3 T4 T5 E5 E6 T6 T7 E7 E8 T8 L9
       ── выполнено ───────────────────────────────┤├─ запл ─
```
...
|---------|----------|--------|----------|
| **Unit / Mock** | Модульные тесты на моках: Vitest (Engine), `cargo test` (TUI). Проверяют отдельные функции, типы, обработчики | ✅ Активно | 457 тестов (270 Engine + 187 TUI) |
