...
│  │  complior passport init|list|show|evidence     Паспорт              │  │
...
│  * T-6   Service + HTTP routes (POST /fix/doc/soa|risk-reg)   ✅     │
│  * T-7   Rust CLI commands (passport soa|risk-register)       ✅     │
│                                                                      │
│  MERGED to dev 2026-04-13. PR #10.                                   │
│  23 tests GREEN + rebased onto dev (resolved 5 file conflicts).      │
│  T-7 (Rust CLI) completed in V1-M12 (VALID_DOC_TYPES + 4 tests).   │
└──────────────────────────────────────────────────────────────────────┘
```
...
### Фаза 2.1: Command Restructuring (V1-M11, 1 неделя) ✅ DONE
...
│  * T-3   Rename /agent/* → /passport/* routes (19 routes)    ✅     │
│  * T-4   Create /fix/doc/* routes (8 routes)                 ✅     │
│  * T-5   Rename Agent → Passport in Rust CLI                 ✅     │
│  * T-6   Add fix --doc flag in Rust CLI                      ✅     │
│  * T-7   Update Rust types (CompliancePosture etc.)          ✅     │
│  * T-8   Update docs (CLAUDE.md, README, CHANGELOG)          ✅     │
│                                                                      │
│  DONE: 2498 tests GREEN. Reviewer APPROVED. TD-14/TD-27 fixed.      │
