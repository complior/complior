...
│                                                                      │
│  3 generators (покрывает Фаза 2 ISO 42001 фичи):                    │
│  * F-V9-24  AI Policy Generator (из Agent Passport)           ⏳     │
│  * F-V9-25  SoA Generator (Statement of Applicability)        ⏳     │
│  * F-V9-26  Risk Register (из FRIA + scan findings)           ⏳     │
│                                                                      │
│  Результат: complior agent policy|soa|risk-register генерируют       │
│  готовые к аудиту ISO 42001 документы из данных Complior             │
