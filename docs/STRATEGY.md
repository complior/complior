...
### Фаза 2.0: Score Transparency (V1-M10, 1 неделя) 🔴 RED TESTS READY
...
│  * T-4   GET /status/posture + CLI complior status           ⏳     │
│  * T-5   RED tests (unit 15 + E2E 5 + acceptance 6)         ✅     │
│                                                                      │
│  Contracts: ScoreDisclaimer, CategoryBreakdown, CompliancePosture   │
│  Branch: feature/V1-M10-score-transparency                           │
│  Tests: 20 RED + 6 acceptance checks                                 │
└──────────────────────────────────────────────────────────────────────┘
```
