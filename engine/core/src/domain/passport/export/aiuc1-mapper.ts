...
const dataPrivacyChecks = (m: AgentPassport): readonly DomainCheck[] => [
...
const securityChecks = (m: AgentPassport): readonly DomainCheck[] => [
...
const safetyChecks = (m: AgentPassport): readonly DomainCheck[] => [
...
const reliabilityChecks = (m: AgentPassport): readonly DomainCheck[] => [
...
const accountabilityChecks = (m: AgentPassport): readonly DomainCheck[] => [
...
const societyChecks = (m: AgentPassport): readonly DomainCheck[] => [
...
export const mapToAIUC1 = (manifest: AgentPassport): AIUC1Profile => {
  const domains = {
