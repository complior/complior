...
const courses = [
  {
    ...
    active: true,
    sortOrder: 0,
    description: 'Kompaktkurs für Geschäftsführer und Vorstände: AI Act' +
      ' Überblick, Haftungsrisiken, Budgetplanung und' +
      ' strategische Verantwortung beim KI-Einsatz.',
    modules: [
      {
        sortOrder: 0,
        ...
        contentMarkdown: '# AI Act im Überblick\n\nDer AI Act (Verordnung' +
          ' (EU) 2024/1689) ist das weltweit erste umfassende' +
          ' KI-Gesetz...',
        quizQuestions: [
          {
          ...
          {
            question: 'Wer ist als "Betreiber" (Deployer) im Sinne des AI' +
              ' Act definiert?',
            options: [
              'Nur Entwickler von KI-Systemen',
              'Jede natürliche oder juristische Person, die ein KI-System' +
              ' unter ihrer Verantwortung einsetzt',
              'Nur öffentliche Einrichtungen',
              'Nur Unternehmen mit mehr als 250 Mitarbeitern',
            ],
            correctAnswer: 1,
            explanation: 'Art. 3(4): Betreiber ist jede Person, die ein' +
              ' KI-System unter eigener Verantwortung nutzt.',
          },
        ],
      },
      {
        ...
        contentMarkdown: '# Haftung und Verantwortung\n\n## Bußgelder\n-' +
          ' Bis zu 35 Mio. EUR oder 7% des weltweiten' +
          ' Jahresumsatzes...',
        quizQuestions: [
          {
            question: 'Wie hoch kann die maximale Geldbuße bei Verstößen' +
              ' gegen verbotene KI-Praktiken sein?',
            options: [
              '10 Mio. EUR', '20 Mio. EUR', '35 Mio. EUR', '50 Mio. EUR'],
            correctAnswer: 2,
            explanation: 'Art. 99(3): Bis zu 35 Mio. EUR oder 7% des' +
      ...
      },
      {
        ...
        quizQuestions: [
          {
            question: 'Was ist die wichtigste erste Maßnahme für' +
              ' Geschäftsführer?',
            options: [
            ...
            correctAnswer: 1,
            explanation: 'Ohne Inventar können Sie weder Risiken bewerten' +
              ' noch Compliance sicherstellen.',
          },
        ],
      },
    ],
  },
  {
    ...
    active: true,
    sortOrder: 1,
    description: 'Spezialkurs für HR-Manager: Hochrisiko-KI im Recruiting' +
      ' und Personalwesen, Annex III Bereich 4,' +
      ' Bewerbermanagement, Leistungsbewertung.',
    modules: [
      {
        sortOrder: 0,
        ...
        contentMarkdown: '# KI im HR: Rechtlicher Rahmen\n\n## Annex III,' +
          ' Bereich 4: Beschäftigung\nKI-Systeme im Bereich' +
          ' Beschäftigung gelten als Hochrisiko...',
        quizQuestions: [
          {
            ...
            correctAnswer: 1,
            explanation: 'Annex III, Nr. 4(a): KI-Systeme zur Einstellung' +
              ' oder Vorauswahl von Bewerbern sind Hochrisiko.',
          },
        ],
      },
      {
        ...
        contentMarkdown: '# Hochrisiko-Szenarien im HR\n\n## Recruiting\n-' +
          ' CV-Screening, Interview-Analyse,' +
          ' Persönlichkeitstests...',
        quizQuestions: [
          {
            question: 'Was müssen Sie als HR-Verantwortlicher bei einer' +
              ' KI-gestützten Bewerbervorauswahl sicherstellen?',
            options: [
            ...
            correctAnswer: 1,
            explanation: 'Art. 26: Betreiber müssen menschliche Aufsicht' +
              ' sicherstellen und das System bestimmungsgemäß' +
              ' verwenden.',
          },
        ],
      },
      {
        ...
        contentMarkdown: '# Praktische Compliance-Schritte\n\n## Checkliste' +
          ' für HR-Manager\n1. KI-Inventar für HR-Tools' +
          ' erstellen...',
        quizQuestions: [
          {
            question: 'Müssen Bewerber informiert werden, wenn KI bei der' +
              ' Vorauswahl eingesetzt wird?',
            options: [
            ...
            correctAnswer: 1,
            explanation: 'Art. 26(7) und Art. 50: Betroffene Personen' +
              ' müssen über den KI-Einsatz informiert werden.',
          },
        ],
      },
    ],
  },
  {
    ...
    active: true,
    sortOrder: 2,
    description: 'Technischer Kurs für Entwickler: Art. 26' +
      ' Betreiberpflichten bei API-Integration, Monitoring,' +
      ' Logging, technische Dokumentation und' +
    ...
    modules: [
      {
        ...
        contentMarkdown: '# AI Act: Technische Grundlagen\n\n##' +
          ' Risikoklassen und ihre technischen' +
          ' Implikationen\n- Prohibited: Social Scoring,' +
          ' Real-time Biometrics...',
        quizQuestions: [
          {
            question: 'Welche technische Maßnahme ist für' +
              ' Hochrisiko-KI-Systeme NICHT vorgeschrieben?',
            options: [
            ...
            correctAnswer: 1,
            explanation: 'Der AI Act verlangt keine' +
              ' Open-Source-Veröffentlichung. Protokollierung,' +
              ' Aufsicht und Datenvalidierung sind hingegen' +
              ' Pflicht.',
          },
        ],
      },
      {
        ...
        contentMarkdown: '# API-Integration und Monitoring\n\n##' +
          ' Logging-Anforderungen\n- Art. 26(6): Automatische' +
          ' Protokolle min. 6 Monate aufbewahren...',
        quizQuestions: [
          {
            question: 'Wie lange müssen automatisch erzeugte Protokolle' +
              ' mindestens aufbewahrt werden?',
            options: ['1 Monat', '3 Monate', '6 Monate', '12 Monate'],
            correctAnswer: 2,
            explanation: 'Art. 26(6): Mindestens 6 Monate, sofern nicht' +
      ...
      },
      {
        ...
        quizQuestions: [
          {
            question: 'Wie muss ein KI-Chatbot gemäß Art. 50 gekennzeichnet' +
              ' werden?',
            options: [
            ...
            correctAnswer: 2,
            explanation: 'Art. 50(1): Natürliche Personen müssen darüber' +
      ...
      },
      {
        ...
        quizQuestions: [
          {
            question: 'Was ist der Vorteil eines hybriden' +
              ' Klassifizierungsansatzes (Rules + LLM)?',
            options: [
            ...
            correctAnswer: 1,
            explanation: 'Die Kombination aus regelbasierter Vorprüfung und' +
              ' LLM-Analyse mit Cross-Validierung erhöht die' +
              ' Zuverlässigkeit der Klassifizierung.',
          },
        ],
      },
    ],
  },
  {
    ...
    active: true,
    sortOrder: 3,
    description: 'Basiskurs für alle Mitarbeiter: KI-Grundlagen, Dos &' +
      ' Don\'ts am Arbeitsplatz, Datenschutz bei KI-Nutzung,' +
      ' Meldepflichten.',
    modules: [
      {
        sortOrder: 0,
        ...
        quizQuestions: [
          {
            ...
            correctAnswer: 1,
            explanation: 'Art. 4: KI-Kompetenz bedeutet Fähigkeiten und' +
              ' Wissen, um KI-Systeme informiert und' +
      ...
      },
      {
        ...
        quizQuestions: [
          {
            question: 'Dürfen Sie vertrauliche Kundendaten in ein' +
              ' öffentliches KI-Tool wie ChatGPT eingeben?',
            options: [
            ...
            correctAnswer: 1,
            explanation: 'Vertrauliche Daten dürfen nur in freigegebene und' +
              ' geprüfte KI-Systeme eingegeben werden.',
          },
        ],
      },
      {
        ...
        quizQuestions: [
          {
            question: 'Was sollen Sie tun, wenn ein KI-System' +
            ...
            correctAnswer: 1,
            explanation: 'Auffälligkeiten und Probleme immer intern melden.' +
              ' Die Meldekette ist: Vorgesetzte →' +
              ' KI-Verantwortliche → ggf. Behörden.',
          },
        ],
      },
    ],
